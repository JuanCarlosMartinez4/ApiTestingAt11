...
class PostBoardRequest(object):
    ...
    def post_board_request(self):
        ...
        self.response = requests.request("POST", self.my_url, params=querystring)
    ...
    def delete_board_request(self):
        url = self.my_url + self.id
